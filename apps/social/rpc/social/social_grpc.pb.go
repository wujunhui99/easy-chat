...
const (
	...
	Social_MyCreatedGroups_FullMethodName   = "/social.social/MyCreatedGroups"
	Social_MutualFriendCount_FullMethodName = "/social.social/MutualFriendCount"
...
func (c *socialClient) MyCreatedGroups(ctx context.Context, in *MyCreatedGroupsReq, opts ...grpc.CallOption) (*MyCreatedGroupsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MyCreatedGroupsResp)
	err := c.cc.Invoke(ctx, Social_MyCreatedGroups_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *socialClient) MutualFriendCount(ctx context.Context, in *MutualFriendCountReq, opts ...grpc.CallOption) (*MutualFriendCountResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MutualFriendCountResp)
	err := c.cc.Invoke(ctx, Social_MutualFriendCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SocialServer interface {
	...
	MyCreatedGroups(context.Context, *MyCreatedGroupsReq) (*MyCreatedGroupsResp, error)
	// 共同好友数量（Redis 求交集）
	MutualFriendCount(context.Context, *MutualFriendCountReq) (*MutualFriendCountResp, error)
	// 更新群信息（带字段掩码）
...
func (UnimplementedSocialServer) MyCreatedGroups(context.Context, *MyCreatedGroupsReq) (*MyCreatedGroupsResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MyCreatedGroups not implemented")
}
func (UnimplementedSocialServer) MutualFriendCount(context.Context, *MutualFriendCountReq) (*MutualFriendCountResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MutualFriendCount not implemented")
}
...
func _Social_MyCreatedGroups_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MyCreatedGroupsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SocialServer).MyCreatedGroups(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Social_MyCreatedGroups_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SocialServer).MyCreatedGroups(ctx, req.(*MyCreatedGroupsReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Social_MutualFriendCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MutualFriendCountReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SocialServer).MutualFriendCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Social_MutualFriendCount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SocialServer).MutualFriendCount(ctx, req.(*MutualFriendCountReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Social_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MyCreatedGroups",
			Handler:    _Social_MyCreatedGroups_Handler,
		},
		{
			MethodName: "MutualFriendCount",
			Handler:    _Social_MutualFriendCount_Handler,
		},
		{
