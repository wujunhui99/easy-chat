...
func (s *SocialServer) MyCreatedGroups(ctx context.Context, in *social.MyCreatedGroupsReq) (*social.MyCreatedGroupsResp, error) {
	l := logic.NewMyCreatedGroupsLogic(ctx, s.svcCtx)
	return l.MyCreatedGroups(in)
}

// 共同好友数量（Redis 求交集）
func (s *SocialServer) MutualFriendCount(ctx context.Context, in *social.MutualFriendCountReq) (*social.MutualFriendCountResp, error) {
	l := logic.NewMutualFriendCountLogic(ctx, s.svcCtx)
	return l.MutualFriendCount(in)
}
