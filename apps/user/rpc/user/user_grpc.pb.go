...
const (
	...
	User_CreateAgent_FullMethodName     = "/user.User/CreateAgent"
	...
	User_GetLoginDevices_FullMethodName = "/user.User/GetLoginDevices"
)
...
func (c *userClient) CreateAgent(ctx context.Context, in *CreateAgentReq, opts ...grpc.CallOption) (*CreateAgentResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateAgentResp)
	err := c.cc.Invoke(ctx, User_CreateAgent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetLoginDevices(ctx context.Context, in *GetLoginDevicesReq, opts ...grpc.CallOption) (*GetLoginDevicesResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetLoginDevicesResp)
	err := c.cc.Invoke(ctx, User_GetLoginDevices_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	GetLoginDevices(context.Context, *GetLoginDevicesReq) (*GetLoginDevicesResp, error)
...
func (UnimplementedUserServer) CreateAgent(context.Context, *CreateAgentReq) (*CreateAgentResp, error) {
...
func (UnimplementedUserServer) GetLoginDevices(context.Context, *GetLoginDevicesReq) (*GetLoginDevicesResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetLoginDevices not implemented")
}
...
func _User_CreateAgent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateAgentReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).CreateAgent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_CreateAgent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).CreateAgent(ctx, req.(*CreateAgentReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _User_GetLoginDevices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLoginDevicesReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).GetLoginDevices(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetLoginDevices_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetLoginDevices(ctx, req.(*GetLoginDevicesReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _User_CreateAgent_Handler,
		},
		{
		...
		{
			MethodName: "GetLoginDevices",
			Handler:    _User_GetLoginDevices_Handler,
		},
	},
