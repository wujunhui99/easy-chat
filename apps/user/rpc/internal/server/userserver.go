...
import (
	...
	"github.com/wujunhui99/easy-chat/apps/user/rpc/internal/logic"
...
func (s *UserServer) GetLoginDevices(ctx context.Context, in *user.GetLoginDevicesReq) (*user.GetLoginDevicesResp, error) {
	l := logic.NewGetLoginDevicesLogic(ctx, s.svcCtx)
	return l.GetLoginDevices(in)
}
